...
var SpecifiedOrdering = map[schema.GroupKind]int{
	{Group: "extensions", Kind: "PodSecurityPolicy"}:                                10,
	{Group: "extensions", Kind: "ThirdPartyResource"}:                               20,
	{Group: "apiextensions.k8s.io", Kind: "CustomResourceDefinition"}:               20,
	{Group: "", Kind: "Namespace"}:                                                  GenericNamespacedOrder - 30,
	{Group: "", Kind: "LimitRange"}:                                                 GenericNamespacedOrder - 20,
	{Group: "", Kind: "ServiceAccount"}:                                             GenericNamespacedOrder - 20,
	{Group: "", Kind: "ConfigMap"}:                                                  GenericNamespacedOrder - 10,
	{Group: "", Kind: "Secret"}:                                                     GenericNamespacedOrder - 10,
	{Group: "extensions", Kind: "DaemonSet"}:                                        GenericPodOrder,
	{Group: "extensions", Kind: "Deployment"}:                                       GenericPodOrder,
	{Group: "extensions", Kind: "ReplicaSet"}:                                       GenericPodOrder,
	{Group: "extensions", Kind: "StatefulSet"}:                                      GenericPodOrder,
	{Group: "apps", Kind: "DaemonSet"}:                                              GenericPodOrder,
	{Group: "apps", Kind: "Deployment"}:                                             GenericPodOrder,
	{Group: "apps", Kind: "ReplicaSet"}:                                             GenericPodOrder,
	{Group: "apps", Kind: "StatefulSet"}:                                            GenericPodOrder,
	{Group: "batch", Kind: "Job"}:                                                   GenericPodOrder,
	{Group: "batch", Kind: "CronJob"}:                                               GenericPodOrder,
	{Group: "", Kind: "Service"}:                                                    GenericPodOrder + 10,
	{Group: "admissionregistration.k8s.io", Kind: "ValidatingWebhookConfiguration"}: GenericPodOrder + 20,
	{Group: "admissionregistration.k8s.io", Kind: "MutatingWebhookConfiguration"}:   GenericPodOrder + 20,
}
